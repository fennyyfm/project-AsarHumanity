            ...
            <form action="/add" method="POST">
                ...
                <fieldset>
                    ...
                    <hr>
                      ...
                      <div class="form-group">
                        <input type="text" name="kontak_donatur" class="form-control" placeholder="Nomor HP" required>
                      </div>
                      <div class="form-group">
                        <input type="number" name="jumlah" class="form-control" placeholder="Jumlah Donasi" required>
                      </div>
                      <div class="form-group">
            					  <textarea class="form-control" name="alamat" rows="3" style="border-radius:25px">Do'a Khusus</textarea>
            					</div>
                      <br>
                        <div class="form-group">
    ...
    <div class="col-sm-8" style="margin-top:150px;">
      <center>
        <div class="col-sm-6">
            ...
            <button class="btn btn-success btn-block btn-lg" type="button" name="button" style="border-radius:50px">Konfirmasi Yuk!</button>
        </div>
      </center>
    </div>
  </div>
